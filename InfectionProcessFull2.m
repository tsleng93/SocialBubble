function [EpiSize, RSize, Rgen, Igen, Deaths, Indiv_Infected] = InfectionProcessFull2(M, eps, C, Infect_0,A,RelTrans,RelInf,Death_Prop)
...
%   - Indiv_Infected is the average number of times each individuals is
%    infected over the 5th to the 9th generaton
