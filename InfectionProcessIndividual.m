function [EpiSize, RSize, Rgen, Igen, Deaths] = InfectionProcessIndividual(M, eps, C, Infect_0,A,RelTrans,RelInf,Death_Prop, randnum)
...
%   age dependent.
%   -rand_num is a random seed to replicate results if desriable
